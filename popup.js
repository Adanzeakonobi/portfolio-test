    ...
    const workArray = [
      {
        ...
        livelink: live,
        sourcelink: source,
        image:'Images/ImgPlaceholder\(1\).png',
      },
      {
        title: 'Professional Art',
        description: "A daily selection of privately personalized reads; no accounts or sign-ups required. has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a standard dummy text.",
        ...
        livelink: live,
        sourcelink: source,
        image:"Images/ImgPlaceholder\(2\).png",
      },
      {
      ...
      },
      {
        ...
        livelink: live,
        sourcelink: source,
        image:"Images/ImgPlaceholder4.png",
      },
      {
        title: 'Website portfolio',
        description: "A daily selection of privately personalized reads; no accounts or sign-ups required. has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a standard dummy text.",
        ...
        livelink: live,
        sourcelink: source,
        image:"Images/ImgPlaceholder5.png",
      },
      {
        title: 'Website portfolio',
        description: "A daily selection of privately personalized reads; no accounts or sign-ups required. has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a standard dummy text.",
        ...
        livelink: live,
        sourcelink: source,
        image:"Images/ImgPlaceholder6.png",
      },
    ...
    for (let i = 0; i < workArray.length; i += 1) {
      ...
      document.querySelector('.workgrid').innerHTML
          ...
          <div class="workgrid2">
              ...
              <img class="workgridp3">${work.image}>
              <ul>
                ${technologieslang}
               </ul>
